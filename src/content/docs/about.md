...
各チュートリアルは上から順に読む必要はなく，興味のある機能から試せます。まず [環境のセットアップ](../dbsec-tutorials/getting-started) で Oracle Database 26ai FREE とクライアント，サンプルスキーマを用意してください。
...
詳細は [環境のセットアップ](../dbsec-tutorials/getting-started) を参照してください。
